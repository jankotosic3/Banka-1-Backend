...
/**
 * DTO za zahtev aktivacije naloga ili promene lozinke klijenta.
 * Sadrzi identifikator potvrde, jednokratni token i novu lozinku.
 */
@Getter
@Setter
@AllArgsConstructor
...
public class ActivateDto {
    ...
    /** Jednokratni token primljen putem aktivacionog linka (URL-safe Base64, duzine 43 znaka). */
    @NotBlank(message = "ConfirmationToken ne sme da bude prazan")
    @Size(min = 43, max = 43, message = "Pogresan token")
    private String confirmationToken;

    /** Nova lozinka klijenta – mora zadovoljiti kompleksnost. */
